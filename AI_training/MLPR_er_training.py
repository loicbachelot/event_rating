...
print("loading data")
train_inputs = np.loadtxt("dataset/train_inputs_er.txt")
print("training inputs loaded")
train_labels = np.loadtxt("dataset/train_labels_er.txt")
print("training labels loaded")
test_inputs = np.loadtxt("dataset/test_inputs_er.txt")
print("testing inputs loaded")
test_labels = np.loadtxt("dataset/test_labels_er.txt")
